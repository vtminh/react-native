...
public class ReactTextShadowNode extends LayoutShadowNode {
  public static final String MINH_TEXT = "minh";
  ...
  private final YogaMeasureFunction mTextMeasureFunction =
      new YogaMeasureFunction() {
        ...
        public long measure(
          ...
          android.util.Log.e("nghia", MINH_TEXT + "test");
          // TODO(5578671): Handle text direction (see View#getTextDirectionHeuristic)
          TextPaint textPaint = sTextPaintInstance;
          Layout layout;
          Spanned text = Assertions.assertNotNull(
              mPreparedSpannableText,
              "Spannable element has not been prepared in onBeforeLayout" + MINH_TEXT);
          ...
          if (boring == null &&
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
              ...
              StaticLayout.Builder builder = StaticLayout.Builder.obtain(text, 0, text.length(), textPaint, (int) width)
                .setAlignment(Layout.Alignment.ALIGN_NORMAL)
                .setLineSpacing(0.f, 1.f)
                .setIncludePad(mIncludeFontPadding)
                .setBreakStrategy(mTextBreakStrategy)
